...
class ProcessCommentDataTableOperator(BaseOperator):
    @apply_defaults
    def __init__(
        self,
        source_task_id: str,
    ...
    def execute(self, context):
        ...
        reddit_comment_csv = context['task_instance'].xcom_pull(key='reddit_post_comment_process_data', task_ids=['sentiment_analysis_task'])[0]
        
        # Create if the table not exists 
        self.create_table(context)
        self.processed_data_ingestion(context, reddit_comment_csv)
